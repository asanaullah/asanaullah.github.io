...
category: DM
layout: blogpost
article: ZipVersa Demo - Part 1 
summary: Step by Step walkthrough for getting the ZipVersa demo up and running
---
## Overview
The goal of the [ZipVersa](https://github.com/ZipCPU/zipvera) project is to demonstrate how a completely open source tool chain can be used to compile HDL designs, including a RISCV core, to a Lattice ECP5-5G Versa FPGA board. 
...
![alt text](/images/blog/DM/zipversa-demo-part-1/hardware_overview.png)
...
![alt text](/images/blog/DM/zipversa-demo-part-1/fft_uart_display.png)
